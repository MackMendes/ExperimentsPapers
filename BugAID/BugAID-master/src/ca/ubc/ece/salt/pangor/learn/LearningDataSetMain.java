...
public class LearningDataSetMain {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			//String featureVector = clusteringDataSet.getLearningFeatureVector();
			String featureVectorHeader = clusteringDataSet.getLearningFeatureVectorHeader();
			// Abaixo já esta tudo certo
			
			dataSetWeka = clusteringDataSet.getWekaDataSet();
			//Abaixo, aparentemente são as estruturas 
			...
			for (weka.core.Instance dataset: dataSetWeka){
				sb.append("\n");
				sb.append(dataset.toString());
			}
			// Colocar o DataSet no csv
			PrintWriter pw = new PrintWriter(new File("dataset_bugid_dinamyc.csv"));
